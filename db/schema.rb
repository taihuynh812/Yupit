...
ActiveRecord::Schema.define(version: 2021_07_13_151335) do
  ...
  create_table "business_amenities", force: :cascade do |t|
    ...
    t.index ["amenity_id"], name: "index_business_amenities_on_amenity_id"
    t.index ["business_id"], name: "index_business_amenities_on_business_id"
  end
